...
def analyze_results(run_name, limit=False, llm_only=True, eval_sim=False):
    ...
    print()
    return unique_mean
values1 = analyze_results("GPT-oss_c-met_tool_use", limit=False, llm_only=True, eval_sim=False)
# values1 = analyze_results("GPT-oss_c-met_tool_use", limit=False, llm_only=True, eval_sim=False)
# values1 = analyze_results("GPT-oss_c-met_tool_use", limit=False, llm_only=True, eval_sim=False)
values1 = analyze_results("GPT-oss_c-met_more_tools", limit=False, llm_only=True, eval_sim=False)
values1 = analyze_results("GPT-oss_c-met_crossover", limit=False, llm_only=True, eval_sim=False)
