...
TOOL_SCHEMAS = [
    ...
    },
    {
        ...
        "description": "Replace a substructure using SMARTS",
        "parameters": {
            "type": "object",
            "properties": {
                "smiles": {"type": "string"},
    ...
    },
    {
        ...
        "description": "Compute RDKit physicochemical descriptors",
        "parameters": {
            "type": "object",
            "properties": {
                "smiles": {"type": "string"}
    ...
    messages = [
        {
            ...
            "content": (
                ...
                "After each tool call modification, inspect the output, and recheck the attachment points.\n"
...
#     state = run_agent(
#         initial_smiles="CNC(=S)c1ccc(-c2cnc3ncc(Cc4cc(Cl)c5ncccc5c4)n3n2)cc1F",
#         user_goal="Improve binding affinity to the protein kinase c-MET"
#     )
...
class GPT4:
    ...
    def edit(self, mating_tuples, mutation_rate, target):
        ...
        try:
            ...
            task_objective = f'Improve binding affinity to the {protein} protein.'
            # mol_tuple = ''
            # for i in range(2):
